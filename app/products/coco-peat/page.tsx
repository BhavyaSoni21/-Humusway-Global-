...
export default function CocoPeat() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-amber-50 to-white pt-36 pb-20 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-16">
          <motion.div
            ...
            className="relative"
          >
            <div className="relative h-[400px] md:h-[500px] rounded-3xl overflow-hidden shadow-2xl bg-gradient-to-br from-amber-100 to-amber-200">
              <Image
